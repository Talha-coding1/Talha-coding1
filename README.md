...
* **Core Domains:** Computer Vision, Deep Learning, Machine Learning pipelines
* **Frameworks & Tools:** YOLO (Object Detection), Roboflow (Dataset Management)
...
* **Advanced Visual Computing:** Generative models, and vision-language integration.
* **Resource-Efficient AI:** Optimizing deep learning networks to run effectively on low-resource hardware.
* **Future Pathway:** Transitioning my practical engineering skills into high-impact academic research and graduate studies (MS/PhD).
